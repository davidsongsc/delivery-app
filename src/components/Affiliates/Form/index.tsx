...
const UserForm: React.FC<UserFormProps> = ({ form, isEditing = false }) => {
  return (
    <Form form={form} layout="vertical" requiredMark={false}>
      <div className='grid grid-cols-12 gap-x-4 border rounded-lg  shadow'>
        <div className='col-span-12 bg-darkBg rounded-lg p-2 mb-2'>
        ...
        <div className='col-span-3 bg-darkBg rounded-lg p-2'>
