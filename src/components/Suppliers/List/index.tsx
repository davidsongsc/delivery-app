...
import { SupplierColumn } from './column'; // Assuming CourseColumn is meant to be UserColumn
...
const SuppliersList: React.FC = () => {
  ...
  const { suppliers, suppliersLoading, suppliersTotal, suppliersRefresh } = userSuppliers(
    useMemo(
      () => ({
        page,
        limit: pageSize,
  ...
  return (
    ...
    <div className="w-7xl container mx-auto">
      ...
      <div className="bg-secondary  rounded-lg shadow-xl">
        ...
        <Table
          rowKey="id"
          columns={SupplierColumn(suppliersRefresh, permissions)}
