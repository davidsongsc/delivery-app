...
const ClienteList: React.FC = () => {
  ...
  const { clientes, clientesLoading, clientesTotal, clientesRefresh } = userClientes(
    useMemo(
      () => ({
        page,
        limit: pageSize,
  ...
  return (
    ...
    <div className="w-7xl container mx-auto">
        ...
        action={
          <>
            {permissions.includes('afiliados_acesso_criar') && (
              <Link href="/dashboard/configuracoes/clientes/cadastrar">
      ...
      <div className="bg-secondary  rounded-lg shadow-xl">
        ...
        <Table
          rowKey="id"
          columns={ClienteColumn(clientesRefresh, permissions)}
          dataSource={clientes}
...
export default React.memo(ClienteList);
