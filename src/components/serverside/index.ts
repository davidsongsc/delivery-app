...
export const listaProdutos: IProduto[] = [
    {
        ...
        valor: 10.99,
        imagem: '/files/imagens/cardapio/1.png',
        categoria: 'Lanches',
        promocional: true,
    ...
    },
    {
        ...
        valor: 11.99,
        imagem: '/files/imagens/cardapio/2.png',
        categoria: 'Lanches',
        promocional: false,
        composicao: ['pão', 'hambúrguer', 'queijo', 'picles', 'cebola'],
    ...
    },
    {
        ...
        valor: 2.99,
        imagem: '/files/imagens/cardapio/3.png',
        categoria: 'Esfirras',
        promocional: false,
        composicao: ['cebola'],
    ...
    },
    {
        ...
        valor: 2.49,
        imagem: '/files/imagens/cardapio/4.png',
        categoria: 'Esfirras',
        promocional: false,
        composicao: ['cebola'],
    },
    {
        ...
        valor: 49.49,
        imagem: '/files/imagens/cardapio/5.png',
        categoria: 'Pizzas',
        promocional: false,
        composicao: ['cebola'],
    },
    {
        ...
        valor: 79.49,
        imagem: '/files/imagens/cardapio/6.png',
        categoria: 'Carnes',
        promocional: false,
        composicao: ['molho'],
    }, {
        ...
        descricao: 'Hambúrguer simples com queijo, picles, cebola e adicionais personalizáveis. Hambúrguer simples com queijo, picles, cebola e adicionais personalizáveis. Hambúrguer simples com queijo, picles, cebola e adicionais personalizáveis.',
        valor: 13.99,
        imagem: '/files/imagens/cardapio/7.png',
        categoria: 'Lanches',
        promocional: false,
        composicao: ['pão', 'hambúrguer', 'queijo', 'picles', 'cebola'],
    ...
    },
    {
        ...
        descricao: 'Hambúrguer completo com tudo: ovo, alface, tomate e mais.',
        valor: 15.99,
        imagem: '/files/imagens/cardapio/8.png',
        categoria: 'Lanches',
        promocional: true,
        composicao: ['pão', 'hambúrguer', 'queijo', 'picles', 'cebola'],
...
export const listaCupons: ICupom[] = [
    ...
    { codigo: 'patraomaluco', tipo: 'porcentagem', valor: 90, usosRestantes: 100 },
];
