    ...
    return (
        <>
            <Dropdown menu={{ items }} trigger={['click']} placement="bottomRight">
                ...
                <div className="flex items-center gap-1 cursor-pointer bg-secondary hover:bg-gray-100 px-4 py-3  shadow-sm transition-colors w-full">
                    <span
                        className={`w-5 h-5 rounded-full ${isAuthenticated ? 'bg-green-500' : 'bg-red-500'}`}
